...
function renderStemModeSelector(data) {
...
function updateModelStatusBar() {
  ...
  if (window.__isDownloading) {
    ...
    textRow.innerHTML = `<span class="spinner"></span> Downloading ${selectedModelName}... This may take a minute`;
    ...
    text.textContent = `${selectedModelName} ready — ${selectedModel.description}`;
...
function renderModelDownloads(data) {
